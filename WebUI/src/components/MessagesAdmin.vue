      ...
      ">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group mr-2">
                    <b-button v-if="isPathMessageList"
                              @click="getList()"
                              variant="primary"
                              size="sm">
        ...
        <filter-message-table :filter="filter"
                              :filterField="filterField"
                              @filterItems="filterItems"></filter-message-table>
        <div id="table-message">
            <table-custom-message ref="table-messages"
        ...
        <b-modal hide-footer :id="infoModal.id" :title="infoModal.title" ok-only>
            <form-custom v-if="infoModal.title"
