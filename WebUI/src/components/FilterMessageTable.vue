  ...
  <div>
    <b-row>
      <b-col sm="6" md="2" lg="2">
        <b-form-group id="local" label="Local station" label-for="local">
          <!-- :value-field="field.value ? field.value : 'hh'" -->
          <b-form-select
            @change="filterItems('local')"
            id="local"
            name="local"
      ...
      <b-col sm="6" md="3" lg="3">
        ...
        <b-form-group v-slot="{ ariaDescribedby }">
          <b-form-checkbox-group
            @change="filterItems('displays')"
            v-model="filter.displays"
          ...
          >
            <!-- :options="listDisplay" -->
            <b-form-checkbox
              v-for="(display, index) in listDisplay"
              :key="index"
              :value="display.value"
            >
      ...
      <b-col sm="6" md="4" lg="4">
        <b-form-group label="Date/time display" v-slot="{ ariaDescribedby }">
          <b-form-radio
            ...
            v-for="(item, index) in listDateTime"
            :key="index"
...
export default {
  props: {
    filter: {
      type: Object,
      default: ()=>{ return  {text:"",location : "",local:"", displays: [],dateTime:"local" }},
    },
  },
  data() {
    return {
      ...
      listDisplay: [
        { text: "Display Ok", value: "Display Ok",badge:"success",ab:"O" },
        { text: "Display Pending", value: "Display Pending", badge:"warning" ,ab:"P" },
        { text: "Display Stop", value: "Display Stop", badge:"danger", ab:"S" },
      ],
      listDateTime: [
