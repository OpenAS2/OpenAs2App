...
public class FilenameParsingTest {
	...
	private static String subjectAttrib = "First part filename: $attributes." + attribNamesFromFileName1
			+ "$  Second part filename: $attributes." + attribNamesFromFileName2 + "$";
	private static String expectedSubject = "First part filename: " + testFileNamePart1
			+ "  Second part filename: " + testFileNamePart2;
