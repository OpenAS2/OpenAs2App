...
:Usage
    echo ma"Generate a certificate to a PKCS12 key store."
  ...
  echo ""
  echo "       eg. gen_p12_key_par as2_certs openas2a SHA1 \"CN=OpenAS2A Testing, OU=QA, O=OpenAS2A, L=New York, S=New York, C=US\""
