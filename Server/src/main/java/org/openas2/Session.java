 ...
 * components. The <code>Session</code> has its own lifecycle controlled by two
 * methods {@link #start()} and {@link #stop()}.
 *
...
public interface Session {
	 ...
	 *
	 * @return the currently registered <code>CertificateFactory</code>
	 * component
	 * @throws ComponentNotFoundException If a <code>CertificateFactory</code>
	 ...
	 * @throws ComponentNotFoundException If a component is not registered with
	 * the ID
	 */
	 ...
	 * @throws ComponentNotFoundException If a <code>PartnerFactory</code>
	 * component has not been registered
	 ...
	 * @throws ComponentNotFoundException If a <code>Processor</code> component
