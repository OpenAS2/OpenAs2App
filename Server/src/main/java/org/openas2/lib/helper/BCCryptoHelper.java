...
public class BCCryptoHelper implements ICryptoHelper {
	...
	public MimeBodyPart sign(MimeBodyPart part, Certificate cert, Key key, String digest, String contentTxfrEncoding, boolean adjustDigestToOldName, boolean isRemoveCmsAlgorithmProtectionAttr)
			throws GeneralSecurityException, SMIMEException, MessagingException {
	...
	/**
	 * Looks up the correct ASN1 OID of the passed in algorithm string and
	 * returns the encryptor. The encryption key length is set where necessary
	 *
	 ...
	 *
	 * TODO: Possibly just use new ASN1ObjectIdentifier(algorithm) instead of
	 * explicit lookup to support random configured algorithms but will require
	 * determining if this has any side effects from a security point of view.
	 */
