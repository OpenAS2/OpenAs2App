 ...
 * object that implements this interface must have a constructor with no
 * parameters, as these parameters should be passed to the init method.
 *
...
public interface Component {
	...
	/**
	 * Returns the Session used to initialize this Component. The returned
	 * session is also used to locate other components if needed.
	 *
	...
	/**
	 * Component lifecycle hook. After creating a Component object, this method
	 * should be called to set any parameters used by the component. Component
	 * implementations typically have required parameter checking and code to
	 ...
	 * @throws OpenAS2Exception If an error occurs while initializing the
	 * component
	 * @see Session
	 */
	...
	/**
	 * Component lifecycle hook. If lifecycle of {@link Component} requires a
	 * destroy function this method can be used.
	 *
