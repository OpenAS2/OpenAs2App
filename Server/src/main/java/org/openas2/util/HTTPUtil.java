...
public class HTTPUtil {
	...
	/**
	 * Simple method to query a site and return the response code and content
	 * (if any) in a hashmap. The returned map key for response code -
	 * "response_code" The returned map key for data - "response_content"
	 *
	...
	/**
	 * Simple method to query a localhost URL with HTTPS using an overridden
	 * name verifier to avoid SSL exceptions Return the response code and
	 * content (if any) in a hashmap. The returned map key for response code -
	 * "response_code" The returned map key for data - "response_content"
	 *
	 * @param urlStr - the string representation of the URL connection
	 * @param params - any parameters to be appended to URL
