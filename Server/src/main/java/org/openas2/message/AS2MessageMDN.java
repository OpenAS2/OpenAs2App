...
public class AS2MessageMDN extends BaseMessageMDN {
	...
	/**
	 * Generate Random Message ID based on data in the preconfigured format,
	 * sender and receiver IDs.
	 *
	 * @return a string
	 * @throws InvalidParameterException - the message ID generator could not
	 * identfy a parameter in the ID format string
	 */
	@Override
