...
public class AS2SenderModule extends HttpSenderModule {
	...
	/**
	 * Stores metadata into pending information file and storing message object
	 * from first send attempt. The message object is written to a separate file
	 * to avoid repeated rewrites of possibly very large objects since it
	 * contains the original file data
	 *
